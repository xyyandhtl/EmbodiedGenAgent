...
ASSET_DICT = {
    ...
    "sketchfab": AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            ...
            usd_path=f"{SIMULATION_DATA_DIR}/terrains/Supermarket/source/supermarket.usdz",
    ...
    "city5": AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            visible=True,
            usd_path=f"{SIMULATION_DATA_DIR}/terrains/City/city5.usdz",
            scale=(2.0, 2.0, 2.0),
        ),
        init_state=AssetBaseCfg.InitialStateCfg(pos=(5.0, -5.0, -1.0), rot=(1.0, 0.0, 0.0, 0.0)),
    ),
}